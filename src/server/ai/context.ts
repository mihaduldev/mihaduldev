...
3) Always collect the visitor's NAME and EMAIL during discovery so Mihadul can reach them.
...
{"visitorName":string|null,"visitorEmail":string|null,"projectType":string|null,"summary":string,"goals":string[],"features":string[],"stack":string[],"timeline":string|null,"budget":string|null,"clarity":"low"|"medium"|"high","nextStep":string,"tags":string[]}
Rules:
...
- Use null or [] when something is unknown. NEVER invent details that are not present in the chat.`,
    },
    {
      role: "user",
